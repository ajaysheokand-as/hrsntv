function ajaxRequest(URL, data, success, admin) {
  var url = ".././api/" + URL;
  if (admin != true) url = "./api/" + URL;
  $.ajax({
    url,
    method: "POST",
...
function sharerUI(url, text) {
  return `<!-- Sharingbutton Facebook -->
    ...
    <a class="resp-sharing-button__link" href="whatsapp://send?text=${text}${url}" target="_blank" rel="noopener" aria-label="">
